...
package net.dryuf.comp.rating.bo;
...
{
	public EntityHolder<RatingHeader> getRatingObject(CallerContext callerContext, long pollId);
	...
	public boolean			deleteRatingStatic(CallerContext callerContext, long pollId);
